<template>
  <div class="home-options-comp">
    ...
    <TieredMenu
      ...
      defaultActiveItem="#"
      :model="[
        { label: $t('Home.Options.newBill'), icon: 'pi pi-fw pi-file', command: () => { }, },
        { label: $t('Home.Options.newSale'), icon: 'pi pi-fw pi-dollar', command: () => { }, },
        { label: $t('Home.Options.newClient'), icon: 'pi pi-fw pi-users', command: () => { }, },
      ]"
      :popup="true"
    />
  </div>
